import CategoryDao from "@daos/Product/ProductCategory";
...
import {
  categorySchema,
  editCategorySchema,
} from "@src/validator/Product/ProductCategory";
...
export async function editCategory(
  ...
  try {
    ...
    const value = await editCategorySchema.validateAsync(req.body);
